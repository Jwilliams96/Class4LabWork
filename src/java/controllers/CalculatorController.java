    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (typeOfRequest.equalsIgnoreCase("rectangle")) {
                ...
                request.setAttribute("typeOfAnswer", 1);
                request.setAttribute("answer", String.valueOf(rac.getArea()));
            } else if (typeOfRequest.equalsIgnoreCase("circle")) {
                String radius = request.getParameter("radius");

                CircleAreaCalculator circleCalc = new CircleAreaCalculator(radius);

                request.setAttribute("typeOfAnswer", 2);
                request.setAttribute("answer", String.valueOf(circleCalc.getArea()));
                ...
                request.setAttribute("typeOfAnswer", 3);
                request.setAttribute("answer", String.valueOf(triCalc.getSide()));
            }
